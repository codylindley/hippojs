...
}, '3.7.0pr3', {"use": ["get", "features", "intl-base", "yui-log", "yui-later"]});
...
YUI.add('yui', function (Y, NAME) {}, '3.7.0pr3', {"use": ["get", "features", "intl-base", "yui-log", "yui-later"]});
...
}, '3.7.0pr3', {"requires": ["oop", "features"]});
...
}, '3.7.0pr3', {"requires": ["dom-base", "dom-style"]});
...
}, '3.7.0pr3', {"requires": ["selector-native"]});
...
}, '3.7.0pr3', {"requires": ["dom-core", "selector"]});
...
}, '3.7.0pr3', {"requires": ["event-base", "node-core", "dom-base"]});
(function () {
...
}, '3.7.0pr3', {"requires": ["pluginhost-base"]});
...
}, '3.7.0pr3', {"requires": ["node-base", "event-delegate"]});
...
}, '3.7.0pr3', {"requires": ["node-base", "pluginhost"]});
...
}, '3.7.0pr3', {"requires": ["dom-style", "node-base"]});
...
}, '3.7.0pr3', {"requires": ["event-custom-base", "querystring-stringify-simple"]});
...
}, '3.7.0pr3', {"requires": ["selector-native", "selector-css2"]});
YUI.add('yui-log', function (Y, NAME) {
...
}, '3.7.0pr3', {"use": ["yui", "oop", "dom", "event-custom-base", "event-base", "pluginhost", "node", "event-delegate", "io-base", "json-parse", "transition", "selector-css3", "dom-style-ie", "querystring-stringify-simple"]});
var Y = YUI().use('*');
