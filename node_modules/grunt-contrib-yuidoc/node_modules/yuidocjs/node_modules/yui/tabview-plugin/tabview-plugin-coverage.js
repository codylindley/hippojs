...
_yuitest_coverage["build/tabview-plugin/tabview-plugin.js"].code=["YUI.add('tabview-plugin', function (Y, NAME) {","","function TabviewPlugin() {","    TabviewPlugin.superclass.constructor.apply(this, arguments);","};","","TabviewPlugin.NAME = 'tabviewPlugin';","TabviewPlugin.NS = 'tabs';","","Y.extend(TabviewPlugin, Y.TabviewBase);","","Y.namespace('Plugin');","Y.Plugin.Tabview = TabviewPlugin;","","","}, '3.7.0pr3', {\"requires\": [\"tabview-base\"]});"];
...
}, '3.7.0pr3', {"requires": ["tabview-base"]});
